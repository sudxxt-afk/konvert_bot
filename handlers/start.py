...
CATEGORY_CARDS = {
    "video": (
        ...
        "⚡️ <b>×1.5 / ×2</b> — ускорить видео\n"
        "✂️ <b>Обрезать</b> — вырезать кусок кнопками ±15с\n\n"
    ...
    "audio": (
        ...
        "⚡️ <b>×1.5 / ×2</b> — ускорить трек\n"
        "✂️ <b>Обрезать</b> — вырезать фрагмент кнопками ±15с\n\n"
        "<blockquote expandable>💡 <b>Советы</b>\n"
    ...
    "doc": (
        ...
        "🔗 <b>/merge</b> — склей несколько PDF в один\n"
        "🗜 <b>ZIP → файлы</b> — распакую архив (до 20 файлов)\n\n"
        "<blockquote expandable>💡 <b>Советы</b>\n"
...
HOWTO = (
    ...
    "• 💬 <b>В группах</b>: реплай на файл — сконвертирую прямо в чате\n"
    "• ⚡️ Ускорение ×1.5 ×2 · ✂️ обрезка видео/аудио\n"
    "• 📄 /merge — склейка PDF · 🗜 распаковка ZIP\n"
